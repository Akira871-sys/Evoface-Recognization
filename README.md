...
這個程式會開啟你的視訊鏡頭，並即時辨識畫面中的人。

1. 環境準備
首先，你需要安裝必要的套件。請在終端機（Terminal/CMD）執行：

Bash
pip install opencv-python face_recognition numpy
注意： face_recognition 依賴 dlib。如果在 Windows 上安裝失敗，建議先安裝 Visual Studio C++ 開發環境。

2. 完整程式碼範例 (main.py)
請將這段程式碼存檔。你需要準備一張你的照片，命名為 my_face.jpg 並放在同一個資料夾。
